    ...
    return (
        <span className='oneOrder'>
            <section className='detailOrder'>
                ...
                <figure className='detailOrder__figure'>
                    <img className='orderImg' src="https://i.ibb.co/FmqdgyY/image.png" alt="Restaurant" />
                </figure>

                <span className='restaurant'>
                    <span className='restaurant__name'><b>Pardes restaurant</b></span>
                    <span className='restaurant__price'><b>$ 132.00</b></span>
                </span>
            ...
            <section className='statuOrders'>
                ...
                <span className='statuOrder'><b>Delivery</b></span>
                <svg onClick={() => handleNavigate('/OrderData')} className='arrowOrder' xmlns="http://www.w3.org/2000/svg" width="5" height="8" viewBox="0 0 5 8" fill="none">
